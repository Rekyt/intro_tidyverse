...
## Case study: 
# [Using Twitter to predict citation rates of ecological research](https://peerj.com/preprints/3180/)
...
[![Watch the video](dplyr_join.mp4)](dplyr_join.mp4)
...
* Check out the [vignette on stringr](http://127.0.0.1:42857/help/library/stringr/doc/stringr.html) for more examples on character manipulation and pattern matching functions.

* Check out the [vignette on regular expressions](http://127.0.0.1:42857/help/library/stringr/doc/regular-expressions.html) which are a concise and flexible tool for describing patterns in strings.
...
* **spread()** and **gather()** from package `tidyr` to reshape tibbles; see [here](http://garrettgman.github.io/tidying/) for exemple 

* **mutate_all()**, **select_if()** and **summarise_at()** or scoped verbs where _scoped_ means that these functions operate only on a selection of variables; see [here](http://www.rebeccabarter.com/blog/2019-01-23_scoped-verbs/) for example
...
```{r message=FALSE, warning=FALSE, paged.print=FALSE, fig.height = 5, fig.width = 8, fig.align = "center"}
citations %>% 
  ggplot() + 
...
```{r message=FALSE, warning=FALSE, paged.print=FALSE, fig.height = 4, fig.width = 8, fig.align = "center"}
citations_ecology %>% 
  ggplot() + 
  aes(x = journal, y = nbtweets, fill = journal) +
  geom_boxplot() +
...
* More about how to (tidy) work with factors [here](https://stat545.com/block029_factors.html) and [here](https://thinkr.fr/forcats-forcats-vous-avez-dit-forcats/).
...
* [Interactive](https://github.com/dreamRs/esquisse) ggplot2 visualizations
...
* Material of the stat545 course on [Data wrangling, exploration, and analysis with R](http://stat545.com/topics.html) at the University of British Columbia
...
knitr::include_graphics("switch_baseR_tidyverse.png")
```
